...
const INGREDIENTS_DESKTOP = [
  { name: 'Basilikum',               dot: [37, 32], label: [28, 20] },
  { name: 'Caputo Rossa Type 00',    dot: [44, 22], label: [44, 4] },
  { name: 'Olivenöl extra vergine',  dot: [60, 22], label: [66, 8] },
  { name: 'Tomaten San Marzano',     dot: [68, 28], label: [76, 16] },
  { name: 'Peperoni',                dot: [60, 52], label: [48, 56] },
  { name: 'Fior di Latte',           dot: [22, 30], label: [10, 22] },
  { name: 'Knoblauch',               dot: [78, 38], label: [92, 28] },
  { name: 'Zwiebeln',                dot: [74, 40], label: [88, 36] },
  { name: 'Zucchetti',               dot: [24, 56], label: [8, 52] },
  { name: 'Champignons',             dot: [26, 48], label: [14, 42] },
  { name: 'Spinat',                  dot: [39, 52], label: [32, 44] },
  ...
  { name: 'Thunfisch',               dot: [52, 82], label: [54, 92] },
  { name: 'Sardellen',               dot: [62, 86], label: [68, 97] },
  { name: 'Rahm',                    dot: [71, 86], label: [82, 95] },
  { name: 'Gorgonzola',              dot: [80, 86], label: [96, 93] },
];

// Mobile coords · iterative corrections
const INGREDIENTS_MOBILE = [
  { name: 'Basilikum',           dot: [38, 36], label: [14, 24] },
  { name: 'Caputo Rossa',        dot: [44, 32], label: [78, 16] },
  { name: 'Olivenöl',            dot: [63, 28], label: [94, 20] },
  { name: 'Tomaten San Marzano', dot: [80, 30], label: [96, 24] },
  { name: 'Fior di Latte',       dot: [22, 38], label: [6, 32] },
  { name: 'Champignons',         dot: [22, 52], label: [4, 48] },
  { name: 'Spinat',              dot: [36, 54], label: [28, 46] },
  { name: 'Knoblauch',           dot: [76, 48], label: [94, 42] },
  { name: 'Zwiebeln',            dot: [76, 48], label: [92, 46] },
  { name: 'Peperoni',            dot: [50, 62], label: [42, 62] },
  { name: 'Zucchetti',           dot: [18, 58], label: [4, 58] },
  ...
  { name: 'Thunfisch',           dot: [60, 78], label: [66, 72] },
  { name: 'Sardellen',           dot: [80, 80], label: [96, 76] },
  { name: 'Rahm',                dot: [91, 82], label: [96, 86] },
  { name: 'Gorgonzola',          dot: [70, 90], label: [94, 88] },
];
